...
CREATE TABLE dp700.masking_demo (
    user_id INT,
...
INSERT INTO dp700.masking_demo (
...
GRANT SELECT ON dp700.masking_demo TO [shruti@labskraft.com];
GO

/*********************************************************************/

SELECT *
FROM dp700.masking_demo
ORDER BY user_id

/*********************************************************************/

ALTER TABLE dp700.masking_demo
...
GRANT UNMASK ON dp700.masking_demo TO [shruti@labskraft.com];
GO

/*********************************************************************/

REVOKE UNMASK ON dp700.masking_demo TO [shruti@labskraft.com];
GO
